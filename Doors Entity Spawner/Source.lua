...
local SelfModules = {
    DefaultConfig = loadstring(game:HttpGet("https://raw.githubusercontent.com/HoangProcoder/spsdoorsmod/main/Doors%20Entity%20Spawner/DefaultConfig.lua"))(),
    Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/HoangProcoder/spsdoorsmod/main/Functions.lua"))(),
}
local ModuleScripts = {
